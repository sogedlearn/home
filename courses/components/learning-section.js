    ...
    getLessonsData() {
        ...
        const courseLessons = {
            ...
            'guna': [
                ...
                { id: 1, title: 'Island Greetings', description: 'Hello, yes, no, thanks and farewells', status: 'completed', xp: 50, duration: 15, exercises: 8, type: 'normal', module: 1 },
                { id: 2, title: 'Family', description: 'Mother, father, grandparents and relatives', status: 'completed', xp: 75, duration: 20, exercises: 10, type: 'normal', module: 1 },
                { id: 3, title: 'Home & Places', description: 'House, store, school and the mola blouse', status: 'completed', xp: 75, duration: 20, exercises: 10, type: 'normal', module: 1 },
                { id: 4, title: 'Nature', description: 'Water, wood, clay and stick', status: 'current', xp: 100, duration: 25, exercises: 12, type: 'normal', module: 1 },
                { id: 5, title: 'Animals', description: 'Turtle, shark, cat, dog and island animals', status: 'locked', xp: 125, duration: 30, exercises: 14, type: 'normal', module: 1 },
                { id: 6, title: 'Plants & Food', description: 'Coconut, corn, fruits and cooking', status: 'locked', xp: 125, duration: 30, exercises: 14, type: 'normal', module: 1 },
                { id: 7, title: 'Basic Conversations', description: 'Where, who, when and everyday phrases', status: 'locked', xp: 125, duration: 30, exercises: 14, type: 'normal', module: 1 },
                { id: 8, title: 'People', description: 'Woman, man, friend and you', status: 'locked', xp: 150, duration: 35, exercises: 16, type: 'normal', module: 1 },
                { id: 9, title: 'Clothing', description: 'Mola blouse and getting dressed', status: 'locked', xp: 150, duration: 35, exercises: 16, type: 'normal', module: 1 },
                { id: 10, title: 'Places', description: 'House, store and school review', status: 'locked', xp: 175, duration: 40, exercises: 18, type: 'normal', module: 1 },
                { id: 11, title: 'Questions', description: 'Where, who and when', status: 'locked', xp: 175, duration: 40, exercises: 18, type: 'normal', module: 2 },
                { id: 12, title: 'Family Review', description: 'Uncle, aunt, nephew and elders', status: 'locked', xp: 200, duration: 45, exercises: 20, type: 'normal', module: 2 },
                { id: 13, title: 'Food & Cooking', description: 'Cook, fruits, onion and meals', status: 'locked', xp: 200, duration: 45, exercises: 20, type: 'normal', module: 2 },
                { id: 14, title: 'Everyday Expressions', description: 'Thank you, today and other', status: 'locked', xp: 225, duration: 50, exercises: 22, type: 'normal', module: 2 },
                { id: 15, title: 'Animals Review', description: 'Cat, dog, chicken and more', status: 'locked', xp: 225, duration: 50, exercises: 22, type: 'normal', module: 2 },
                { id: 16, title: 'Nature & Materials', description: 'Stick, clay, water and wood', status: 'locked', xp: 250, duration: 55, exercises: 24, type: 'normal', module: 2 },
                { id: 17, title: 'Guna Culture', description: 'Ceremony, guide and mola', status: 'locked', xp: 250, duration: 55, exercises: 24, type: 'normal', module: 2 },
                { id: 18, title: 'Greetings Review', description: 'How are you, no and see you tomorrow', status: 'locked', xp: 275, duration: 60, exercises: 26, type: 'normal', module: 2 },
                { id: 19, title: 'Daily Life Mix', description: 'Cook, get dressed and listen', status: 'locked', xp: 275, duration: 60, exercises: 26, type: 'normal', module: 2 },
                { id: 20, title: 'Linguistic Mastery', description: 'Final review of recorded Guna words', status: 'locked', xp: 300, duration: 90, exercises: 30, type: 'boss', module: 2 }
            ],
            'embera': [
